...
```{r}
realized_graph <- ggplot() + geom_line(data = mean_genload_df, aes(x = generation, y = realized_load), color = "orange", size = 1 ) +  geom_line(data = mean_rm_df, aes(x = generation, y = realized_load), color = "lightgray", size = 1 ) + geom_line(data = mean_random_df, aes(x = generation, y = realized_load), color = "red", size = 1 ) + labs(x = "Generations", y = "Realized load") +
  theme(
...
load_graph <- ggplot() + geom_line(data = mean_genload_df, aes(x = generation, y = genetic_load), color = "orange", size = 1 ) +  geom_line(data = mean_rm_df, aes(x = generation, y = genetic_load), color = "lightgray", size = 1 ) + geom_line(data = mean_random_df, aes(x = generation, y = genetic_load), color = "red", size = 1 ) + labs(x = "Generations", y = "Genetic load") + theme(
    plot.background = element_rect(fill = "black"),
    panel.background = element_rect(fill = "black"),
    panel.grid.major = element_line(color = "gray30"),
    panel.grid.minor = element_line(color = "gray20"),
...
fitness_graph <- ggplot() + geom_line(data = mean_genload_df, aes(x = generation, y = fitness), color = "orange", size = 1 ) + geom_line(data = mean_rm_df, aes(x = generation, y = fitness), color = "lightgray", size = 1 ) + geom_line(data = mean_random_df, aes(x = generation, y = fitness), color = "red", size = 1 ) + labs(x = "Generations", y = "Fitness") + theme(
    plot.background = element_rect(fill = "black"),
    panel.background = element_rect(fill = "black"),
    panel.grid.major = element_line(color = "gray30"),
    panel.grid.minor = element_line(color = "gray20"),
...
hetero_graph <- ggplot() + geom_line(data = mean_genload_df, aes(x = generation, y = heterozygosity), color = "orange", size = 1 ) + geom_line(data = mean_rm_df, aes(x = generation, y = heterozygosity), color = "lightgray", size = 1 ) + geom_line(data = mean_random_df, aes(x = generation, y = heterozygosity), color = "red", size = 1 ) + labs(x = "Generations", y = "Number of unique mutation") + theme(
    plot.background = element_rect(fill = "black"),
    panel.background = element_rect(fill = "black"),
    panel.grid.major = element_line(color = "gray30"),
    panel.grid.minor = element_line(color = "gray20"),
...
legend_plot <- ggplot(legend_data, aes(x = x, y = y, color = group)) +
  ...
  scale_color_manual(
    values = c(
      "Minimize load" = "orange",
      "Random mating related" = "lightgray",
      "Random mating" = "red"
    )
  ) +
