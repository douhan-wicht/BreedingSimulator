...
rm_df <- read.table(paste0(path,"1_Outputs/1_Random-Relatedness/random-relatedness_5000burn_100gen_1_popstats.txt"), header = T)


for(i in 2:2){
  df <- read.table(paste0(path,"1_Outputs/1_Random-Relatedness/random-relatedness_5000burn_100gen_", i, "_popstats.txt"), header = T)
...
genload_df <- read.table(paste0(path, "1_Outputs/3_Genetic-Load/genetic_load_5000burn_100gen_1_popstats.txt"), header = T)


for(i in 2:2){
  df <- read.table(paste0(path, "1_Outputs/3_Genetic-Load/genetic_load_5000burn_100gen_", i, "_popstats.txt"), header = T)
...
related_df <- read.table(paste0(path,"1_Outputs/2_Relatedness/relatedness_10000burn_100gen_1_popstats.txt"), header = T)
...
related_df$PopulationID <- rep(1:40, each = 101)
#load genetic + relatedness

mixed_df <- read.table(paste0(path, "1_Outputs/4_Mixed/mixed_5000burn_100gen_1_popstats.txt"), header = T)


for(i in 2:2){
  df <- read.table(paste0(path, "1_Outputs/4_Mixed/mixed_5000burn_100gen_", i, "_popstats.txt"), header = T)
...
random_df <- read.table(paste0(path, "1_Outputs/0_Random/random_5000burn_100gen_1_popstats.txt"), header = T)


for(i in 2:2){
  df <- read.table(paste0(path, "1_Outputs/0_Random/random_5000burn_100gen_", i, "_popstats.txt"), header = T)
...
mean_mixed_df <- cbind(gen, heterozygo, genetic_load, realized_load, fitness)
